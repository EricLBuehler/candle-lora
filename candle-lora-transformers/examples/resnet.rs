...
use candle_lora_transformers::{resnet, varbuilder_utils::from_mmaped_safetensors};
...
pub fn main() -> anyhow::Result<()> {
    ...
    let model = match args.which {
        Which::Resnet18 => resnet::resnet18(class_count, vb, true, loraconfig)?,
        Which::Resnet34 => resnet::resnet34(class_count, vb, true, loraconfig)?,
        Which::Resnet50 => resnet::resnet50(class_count, vb, true, loraconfig)?,
        Which::Resnet101 => resnet::resnet101(class_count, vb, true, loraconfig)?,
        Which::Resnet152 => resnet::resnet152(class_count, vb, true, loraconfig)?,
    };
    println!("model built");
